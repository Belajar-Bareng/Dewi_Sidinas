...
VALUES
('', '$judul', '$tgl_publikasi', '$isi', 'nm_admin')";
            ...
            <div class="card card-primary">
              ...
              <form action="" method="post">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="nm_admin">Admin</label>
                      <select class="form-control" name="nm_admin">
					               <option></option>
					                	<?php
					                    	$q = $koneksi->query ("SELECT * FROM admin");
							                        while ($pilihan_admin = $q->fetch_assoc()){
							                      	echo "<option value='$pilihan_admin[nm_admin]'>
									                    $pilihan_admin[nm_admin]</option>";
					                      		}
					                  	?>
					               </select>
                    </div>
